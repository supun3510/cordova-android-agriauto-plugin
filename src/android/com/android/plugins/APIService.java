...
public class APIService{
	...
	protected boolean SendGPSData(ArrayList<GPSLocations> GPSLLst,int UserId){  
	...
	Thread thread = new Thread(new Runnable() {		 
					...
					public void run() {
						...
						try{ 
							...
							JSONArray lst= ListToJson(GPSLLst);				   
							URL obj = new URL(URl);
							...
							String urlParameters = "LocationList="+ lst.toString() +"&UserId="+ UserId;
